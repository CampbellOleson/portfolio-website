      ...
      <div id="fishhook-wrapper" className="cs-wrapper">
          ...
          <div className="vert-center">
            <section className="cs-topper-info">
              ...
              <summary>
                ...
                fishing enthusiasts an online platform where they can connect
                with one another, share their best catches, and discover new
                fishing spots.
              </summary>
            </section>
          </div>
        ...
        <div className="hor-center">
          <div className="cs-textblock">
            ...
            <article>
              During the later portion of my software development course with
              App Academy, I was tasked with creating a full-stack web
              application. The purpose and implementation details of the website
              were up to me to figure out. I noticed an abundance of
              fishing-themed Facebook groups, and I myself am an avid
              fly-fisher, so for my project I decided to create a social media
              platform specifically designed for people who love to fish (and
        ...
        <div className="hor-center">
          <div className="cs-textblock">
            ...
            <article>
              ...
              with one another. Furthermore, Fishhook users would need to be
              able to personalize their account and post content for their
              friends to see. It sounded simple in the early stages, but as I
              delved further into it, I determined that my app would need user
              entities with associated post entities, a friend requests system,
              a search component, profile page components, feed components, and
              much more.
            </article>
            <article>
              ...
              completion of this assignment, so after my pen-and-paper
              wireframes were complete, I began developing.
            </article>
          </div>
        </div>
        ...
        <div className="hor-center">
          <div className="cs-textblock cs-bmo">
            ...
            <article>
              ...
              PostgreSQL for the database. I chose this stack so I could
              leverage Rails’s convention-over-configuration philosophy for
              quick development and SQL to manage relationships between
              different entities in my database. I then tested my backend API
              using Postman before moving on.
            </article>
            <article>
            ...
            <article className="cs-bmo">
              ...
              clicking the “Add Friend” button. Incoming friend requests are
              found in a dropdown modal attached to the top nav. Users can
              accept incoming friend requests, or delete them.
            </article>
          </div>
        </div>
        ...
        <div className="hor-center">
          <div className="cs-textblock cs-bmo">
            ...
            <article>
              ...
              new programmer. The first challenge I came across was how to
              create “friend-requests” between users that would associate the
              users as “friends” when accepted and allow them to see each
              other's posts.
            </article>
            <article className="cs-bmo">
              ...
              not the request had been accepted. The friendships controller
              creates an entry in this table whenever a user sends a friend
              request. Once the receiving user accepts the request, the status
              field is updated, and the entry becomes a “friends” association
              between the users.
            </article>
          </div>
        </div>
        ...
        <div className="hor-center">
          <div className="cs-textblock">
            ...
            <article>
              ...
              Not every aspect of this app is production quality, and there are
              still plenty of features for me to improve upon.
            </article>
            <article>
              ...
              Fishhook turned out to be an excellent learning experience, and
              gave me a strong sense of the fundamentals of web development.
            </article>
          </div>
        </div>
      </div>
      <MoreProjects exclude="fh" />
    </div>
  );
};
