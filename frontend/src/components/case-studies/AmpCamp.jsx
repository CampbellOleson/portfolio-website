          ...
          <div className="vert-center">
            <section className="cs-topper-info">
              ...
              <summary>
                ...
                to empower musicians to easily share their music with others,
                and to give listeners a way to discover new music.
              </summary>
            </section>
          </div>
        ...
        <div className="hor-center">
          <div className="cs-textblock">
            ...
            <article>
              ...
              AmpCamp. We determined that AmpCamp should provide listeners with
              an easy way to discover new music. We also wanted our website to
              cater to burgeoning musicians, so we chose to integrate a
              user-friendly way to upload albums.
            </article>
            <article>
            ...
            <article>
              ...
              help my team divide and organize responsibilities for this
              project.
            </article>
          </div>
        </div>
        ...
        <div className="hor-center">
          <div className="cs-textblock cs-bmo">
            ...
            <article className="cs-bmo">
              ...
              recommendations. On the homepage, users can also search for
              artists, albums, and songs. When you mouseover an album on the
              homepage, a play pause button appears and allows you to start
        ...
        <div className="hor-center">
          <div className="cs-textblock cs-bmo">
            <article className="cs-bmo">
              ...
              songs. Users listen to songs by clicking on song index items in
              the list. When listening to a particular song, you can see the
              song name, artist name, and album cover art displayed on the audio
        ...
        <div className="hor-center">
          <div className="cs-textblock cs-bmo">
            ...
            <article>
              ...
              immediately after an artist submitted an album. Occasionally,
              albums would fail to upload to AWS S3 Bucket part of the way
              through, leaving the artist with a semi-uploaded album.
            </article>
            <article>
              ...
              the artist will get a user-friendly error message prompting them
              to try their upload again in a moment. The upload-upload component
              also keeps its local state even when an upload fails, so artists
              don’t have to reconstruct the album with every upload attempt.
            </article>
          </div>
        </div>
        ...
        <div className="hor-center">
          <div className="cs-textblock">
            ...
            <article>
              ...
              me to some of the more advanced, DevOps-related technologies of
              web development, such as Docker and AWS. It also gave me
              experience collaborating with others on an advanced project with
              lots of interconnected pieces, and managing responsibilities
              accordingly.
            </article>
            <article>
              AmpCamp turned out to be fully-functional music sharing site with
              an intuitive user interface, and a robust framework for
              asynchronous uploading files to AWS. Anyone can sign up for
              AmpCamp and upload music of their own!
            </article>
          </div>
        </div>
      </div>
      <MoreProjects exclude="ac" />
    </div>
  );
};
